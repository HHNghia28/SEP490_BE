...
namespace SEP490_API.Migrations
{
    ...
    [Migration("20240505031504_createAccountAdmin")]
            ...
            modelBuilder.Entity("BusinessObject.Entities.Account", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            ID = "GV0001",
                            CreateAt = new DateTime(2024, 5, 5, 10, 15, 3, 725, DateTimeKind.Local).AddTicks(8261),
                            CreateBy = "GV0001",
                            IsActive = true,
                            Password = "$2a$11$jp.Yl0PovlDZizEI9r8BIeBGr4pufkEmfekWlTn4W8ycMOSidTHee",
                            RefreshToken = "",
                            RefreshTokenExpires = new DateTime(2024, 5, 5, 10, 15, 3, 927, DateTimeKind.Local).AddTicks(2835),
                            UpdateAt = new DateTime(2024, 5, 5, 10, 15, 3, 725, DateTimeKind.Local).AddTicks(8262),
                            UpdateBy = "GV0001",
                            UserID = new Guid("551b2cec-eaf0-4856-b892-f8ee4af4d3a3"),
                            Username = "Admin"
                        });
                });
            ...
            modelBuilder.Entity("BusinessObject.Entities.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ID = new Guid("551b2cec-eaf0-4856-b892-f8ee4af4d3a3"),
                            Address = "600 Nguyễn Văn Cừ",
                            Avatar = "https://cantho.fpt.edu.vn/Data/Sites/1/media/logo-moi.png",
                            Birthday = new DateTime(2024, 5, 5, 10, 15, 3, 725, DateTimeKind.Local).AddTicks(7981),
