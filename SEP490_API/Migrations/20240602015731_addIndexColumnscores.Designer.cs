...
namespace SEP490_API.Migrations
{
    ...
    [Migration("20240602015731_addIndexColumnscores")]
    partial class addIndexColumnscores
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("BusinessObject.Entities.Account", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ID = "GV0001",
                            IsActive = true,
                            Password = "$2a$11$VQQpurGxuCXK8yi1tQRNfeX9vZh1Fa5CH3aLR1XbyqjfqEi92qFk6",
                            RefreshToken = "",
                            RefreshTokenExpires = new DateTime(2024, 6, 2, 8, 57, 31, 227, DateTimeKind.Local).AddTicks(571),
                            UserID = new Guid("4a38eb5c-c68f-4d31-af7b-9357e7b016b9"),
                            Username = "Admin"
                        },
                        new
                        {
                            ID = "GV0002",
                            IsActive = true,
                            Password = "$2a$11$edTou6S4O3e7iDvlTOl3Mug3AR8WG1.Xu8uKrqdAGvx4NMHRDuPe6",
                            RefreshToken = "",
                            RefreshTokenExpires = new DateTime(2024, 6, 2, 8, 57, 31, 404, DateTimeKind.Local).AddTicks(188),
                            UserID = new Guid("4a8203e2-955b-419f-ab39-b87eb9146142"),
                        ...
                        new
                        {
                            ID = "GV0003",
                            IsActive = true,
                            Password = "$2a$11$rUnZUoIqcX8D0.8mBZQhlu0PAT/yyVMgVaGC6lty0ACckPPY1JBkS",
                            RefreshToken = "",
                            RefreshTokenExpires = new DateTime(2024, 6, 2, 8, 57, 31, 577, DateTimeKind.Local).AddTicks(3817),
                            UserID = new Guid("904cb3bd-362e-4ee8-abd4-eef463631e03"),
                        ...
                        new
                        {
                            ID = "GV0004",
                            IsActive = true,
                            Password = "$2a$11$Xw9ssZo13jXLiRvKHITqPeBBHhBBROVGh3pQvnvPh.TY2V7jqsaMK",
                            RefreshToken = "",
                            RefreshTokenExpires = new DateTime(2024, 6, 2, 8, 57, 31, 748, DateTimeKind.Local).AddTicks(9154),
                            UserID = new Guid("f004d4e0-b54a-417b-bf76-c60b7bf54f9d"),
                            Username = "Supervisor"
                        });
                });
            ...
            modelBuilder.Entity("BusinessObject.Entities.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ID = new Guid("4a38eb5c-c68f-4d31-af7b-9357e7b016b9"),
                            Address = "600 Nguyễn Văn Cừ",
                            Avatar = "https://cantho.fpt.edu.vn/Data/Sites/1/media/logo-moi.png",
                            Birthday = new DateTime(2024, 6, 2, 8, 57, 31, 55, DateTimeKind.Local).AddTicks(7375),
                        ...
                        new
                        {
                            ID = new Guid("4a8203e2-955b-419f-ab39-b87eb9146142"),
                            Address = "600 Nguyễn Văn Cừ",
                            Avatar = "https://cantho.fpt.edu.vn/Data/Sites/1/media/logo-moi.png",
                            Birthday = new DateTime(2024, 6, 2, 8, 57, 31, 227, DateTimeKind.Local).AddTicks(924),
                            Email = "admin@fpt.edu.vn",
                            Fullname = "Lê Văn Admin",
                            Gender = "Nam",
                            IsBachelor = false,
                        ...
                        new
                        {
                            ID = new Guid("904cb3bd-362e-4ee8-abd4-eef463631e03"),
                            Address = "600 Nguyễn Văn Cừ",
                            Avatar = "https://cantho.fpt.edu.vn/Data/Sites/1/media/logo-moi.png",
                            Birthday = new DateTime(2024, 6, 2, 8, 57, 31, 404, DateTimeKind.Local).AddTicks(525),
                            Email = "admin@fpt.edu.vn",
                            Fullname = "Lê Văn Admin",
                            Gender = "Nam",
                            IsBachelor = false,
                        ...
                        new
                        {
                            ID = new Guid("f004d4e0-b54a-417b-bf76-c60b7bf54f9d"),
                            Address = "600 Nguyễn Văn Cừ",
                            Avatar = "https://cantho.fpt.edu.vn/Data/Sites/1/media/logo-moi.png",
                            Birthday = new DateTime(2024, 6, 2, 8, 57, 31, 577, DateTimeKind.Local).AddTicks(4052),
                            Email = "admin@fpt.edu.vn",
                            Fullname = "Lê Văn Admin",
                            Gender = "Nam",
                            IsBachelor = false,
